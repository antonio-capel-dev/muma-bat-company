      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            ...
            element={<RealidadVirtual />}
          />
          <Route path="/servicios/refugios" element={<Refugios />} />
          <Route path="/servicios/bat-night" element={<BatNight />} />
          <Route
            path="/servicios/bat-night/portugal-grutas-moeda"
            element={<BatNightPortugal />}
          />
          <Route
            path="/servicios/bat-night/cueva-nerja"
            element={<BatNightNerja />}
          />
          <Route
            path="/servicios/bat-night/plaza-mayor-malaga"
            element={<BatNightPlazaMayor />}
          />
          <Route
            path="/servicios/bat-night/fuente-de-piedra"
            element={<BatNightFuentePiedra />}
          />
          <Route
            path="/servicios/educacion-ambiental"
            element={<EducacionAmbiental />}
          />
