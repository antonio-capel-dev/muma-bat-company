...
export default function WhatsAppButton() {
    ...
    // La burbuja aparece después de 3 segundos en la página
    ...
    return (
        <div className="fixed right-6 top-1/2 -translate-y-1/2 z-50 flex flex-row-reverse items-center gap-3">

            {/* Burbuja de texto — aparece después de 3s */}
            {burbujaVisible && (
                <div className="bg-white text-gray-800 text-sm font-medium px-4 py-2.5 rounded-2xl rounded-tr-none shadow-lg max-w-[180px] leading-snug">
                    ¿Hablamos? <span className="text-[#25D366] font-bold">Respondemos en minutos</span>
                </div>
            )}
