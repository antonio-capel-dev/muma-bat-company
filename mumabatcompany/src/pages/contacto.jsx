...
import { Mail, Phone, MapPin, MessageCircle, ChevronDown, Send, CheckCircle2, Loader2 } from 'lucide-react'
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { error } = await supabase
        .from('contactos') // Asegúrate de que la tabla se llame así
        .insert([
          {
            nombre: form.nombre,
            email: form.email,
      ...
      // Resetear formulario tras 3 segundos
      setTimeout(() => {
