...
export default function NotFound() {
  return (
    <main className="min-h-screen bg-fondo-base flex flex-col items-center justify-center px-6 text-center">
      ...
      {/* Animación Lottie del murciélago */}
      <Player
        autoplay
        loop
      ...
      <Link
        to="/"
        className="inline-flex items-center gap-2 px-8 py-4 bg-marca-principal text-black font-bold rounded-xl hover:opacity-90 transition-opacity no-underline"
      >
