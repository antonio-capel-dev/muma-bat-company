...
const servicios = [
  { id: 'bat-night', Icono: Moon, titulo: 'Bat Night', descripcion: 'Actividades nocturnas guiadas con detección de ultrasonidos, diseñadas para grupos, festivales, centros de naturaleza y ayuntamientos.', etiqueta: 'Experiencias', enlace: '#contacto' },
  { id: 'museo-virtual', Icono: MonitorPlay, titulo: 'Museo Virtual y Realidad Virtual', descripcion: 'Exposiciones digitales e inmersivas sobre murciélagos. Contenidos para museos, centros de interpretación y espacios educativos.', etiqueta: 'Inmersivo', enlace: '#contacto' },
  { id: 'refugios', Icono: TreePine, titulo: 'Refugios para murciélagos', descripcion: 'Diseño, fabricación e instalación de refugios. Solución basada en la naturaleza para control de plagas y restauración de poblaciones.', etiqueta: 'Infraestructura', enlace: '#contacto' },
...
function SeccionContacto() {
  ...
  const handleEnvio = (e) => { e.preventDefault(); setEnviado(true) }
      ...
      <div className="max-w-2xl mx-auto">
        <motion.div initial="oculto" whileInView="visible" viewport={{ once: true }} variants={varianteSeccion} className="text-center mb-12">
          ...
          <p className="text-texto-secundario">
            ...
            <a href="https://wa.me/34600000000" target="_blank" rel="noopener noreferrer" className="text-estado-exito hover:opacity-80 font-medium no-underline">WhatsApp</a>.
          </p>
        </motion.div>
        <motion.div initial="oculto" whileInView="visible" viewport={{ once: true }} variants={{ oculto: { opacity: 0, y: 24 }, visible: { opacity: 1, y: 0, transition: { duration: 0.5, delay: 0.1 } } }} className="bg-fondo-formulario rounded-2xl p-8 shadow-lg">
          {enviado ? (
            ...
            <form onSubmit={handleEnvio} className="space-y-5" noValidate>
              ...
              <button type="submit" className="w-full py-3.5 rounded-xl text-sm font-semibold bg-marca-principal text-texto-sobre-accion hover:bg-marca-principal-hover transition-colors duration-200">
                Enviar consulta
              </button>
            </form>
          )}
