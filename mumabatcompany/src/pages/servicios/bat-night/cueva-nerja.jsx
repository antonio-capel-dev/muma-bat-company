...
import { cuevaNerjaI18n } from '../../../data/i18n/cuevaNerjaI18n'
...
export default function CuevaNerja() {
  ...
  const t = cuevaNerjaI18n[locale] || cuevaNerjaI18n.es
          ...
          <div className="max-w-4xl mx-auto">
            <motion.div initial="oculto" whileInView="visible" viewport={{ once: true }} variants={varianteSeccion}>
              ...
              <div className="space-y-4 text-texto-secundario leading-relaxed">
                <p>
                  {t.eventoPárrafo1} <strong className="text-texto-principal">{t.eventoPárrafo1Fundacion}</strong> {t.eventoPárrafo1Y} <strong className="text-texto-principal">{t.eventoPárrafo1Parador}</strong> {t.eventoPárrafo1Fecha}
                </p>
                <p>
                  {t.eventoPárrafo2Inicio} <strong className="text-texto-principal">{t.eventoPárrafo2Conservacion}</strong>{t.eventoPárrafo2Resto}
                </p>
                <p>
                  {t.eventoPárrafo3Inicio} <strong className="text-texto-principal">{t.eventoPárrafo3Fechas}</strong>{t.eventoPárrafo3Resto}
                </p>
                <p>
                  {t.eventoPárrafo4}
                </p>
